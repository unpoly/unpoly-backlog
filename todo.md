...
- New demo
  ...
  - Explain sections
  - Clean up start page
    - Refer to other demos
    - Say thanks to Philip
  - Share on forum

- New unpoly.com landing page
  - See balsamiq mockup
...
- Scope up-hungry to sections of the page
...
- Consider bringing the flash nonce pattern into the library
  ...
  - But what I really want is to change the cached response text
    => Would be possible on text, but not on a parsed document (because performance).
